  ...
  const products = [
    {
      ...
      description: 'Next-generation unmanned aerial system for precision strikes',
      color: '#D4AF37',
      image: '/damisa.webp',
    },
    {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.p 
            ...
            variants={titleVariants}
          >
            Our fleet of advanced unmanned aerial systems is designed to meet the diverse needs of modern operations, from tactical reconnaissance to precision engagement.
          </motion.p>
        </motion.div>
              ...
              <div className="relative h-[300px] w-full overflow-hidden glass-effect rounded-lg shadow-soft">
                ...
                <div className="absolute inset-0 group-hover:scale-110 transition-transform duration-700">
                  <div className="w-full h-full bg-white">
                    ...
                    <div 
                      ...
                      style={{ background: getProductPattern(index), backgroundSize: index % 2 === 0 ? '10px 10px' : '20px 20px' }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <motion.img
                    src={product.image}
                    alt={product.name}
                    className="max-h-[150px] w-auto object-contain z-10"
                    animate={{
                ...
                <div className="absolute top-10 right-10">
                  <motion.div 
                    ...
                    animate={{
                      y: hoveredProduct === product.id ? [-5, 5, -5] : 0,
                      rotateZ: hoveredProduct === product.id ? [-3, 3, -3] : 0,
                    }}
                    transition={{
                      duration: 2,
                      repeat: Infinity,
