        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <p className="text-blue-accent font-medium mb-6 italic">
              Next-generation unmanned aerial system for precision strikes and
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              The Damisa Attack Drone, named after the Hausa word for "tiger,"
              embodies raw power, precision, and intelligence. Built for
              unrivaled battlefield dominance with stealth, agility, and lethal
              precision, it delivers swift and unstoppable performance in the
              harshest combat environments.
            </motion.p>
            ...
            >
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Electronic Warfare Resilience with adaptive frequency
                    hopping
                  </span>
                </li>
                <li className="flex items-start gap-2">
