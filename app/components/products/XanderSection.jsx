        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Named after the Greek word for "Defender of Man," Xander embodies
              the essence of legendary guardians—unwavering, vigilant, and
              ever-watchful. The Xander ensures that no enemy moves unseen, no
              battlefield remains unknown, and no mission is compromised.
            </motion.p>
