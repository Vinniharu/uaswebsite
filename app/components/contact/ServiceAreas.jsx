      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-black/70 max-w-2xl mx-auto">
            Briech UAS provides drone solutions across various sectors including:
          </p>
        </motion.div>
        ...
        >
          {sectors.map((sector, index) => (
            <motion.div
              key={index}
              className="bg-white rounded-lg shadow-soft border border-gold/10 p-6 flex items-center gap-4 hover:border-gold/30 transition-colors"
              variants={itemVariants}
            >
              <div className="w-12 h-12 rounded-full bg-gold/10 flex items-center justify-center text-gold flex-shrink-0">
                {sector.icon}
              </div>
              <span className="font-medium text-black/80">{sector.name}</span>
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <p className="text-black/70 max-w-2xl mx-auto mb-8">
            Need a specialized drone solution for your industry? Our team can create customized UAV systems
            tailored to your specific requirements.
          </p>
          
          <button onClick={() => document.getElementById('contact-form').scrollIntoView({ behavior: 'smooth' })} className="inline-flex items-center text-gold hover:text-blue-accent transition-colors gap-2 font-medium">
            <span>Discuss your specific needs with us</span>
